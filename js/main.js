...
let closeIcon = document.querySelector(".bar-icon");
...
function showContacts(){
    ...
    <div class="container">
        ...
        <div class="container w-75 text-center">
            <div class="row g-4">
                <div class="col-md-6">
                    <input id="nameInput" onkeyup="isValid(${regex.nameRegex}, this)" type="text" class="form-control" placeholder="Enter Your Name">
                    <div id="nameAlert" class="alert alert-danger w-100 mt-2 d-none">
                        Special characters and numbers not allowed
                    </div>
                </div>
                <div class="col-md-6">
                    <input id="emailInput" onkeyup="isValid(${regex.email}, this)" type="email" class="form-control " placeholder="Enter Your Email">
                    <div id="emailAlert" class="alert alert-danger w-100 mt-2 d-none">
                        Email not valid *user@example.com
                    </div>
                </div>
                <div class="col-md-6">
                    <input id="phoneInput" onkeyup="isValid(${regex.phonenumber}, this)" type="text" class="form-control " placeholder="Enter Your Phone">
                    <div id="phoneAlert" class="alert alert-danger w-100 mt-2 d-none">
                        Enter valid Phone Number
                    </div>
                </div>
                <div class="col-md-6">
                    <input id="ageInput" onkeyup="isValid(${regex.age}, this)" type="number" class="form-control " placeholder="Enter Your Age">
                    <div id="ageAlert" class="alert alert-danger w-100 mt-2 d-none">
                        Enter valid age
                    </div>
                </div>
                <div class="col-md-6">
                    <input id="passwordInput" onkeyup="isValid(${regex.password}, this)" type="password" class="form-control " placeholder="Enter Your Password">
...
function rePasswordValid(r){
    ...
    if (r.value === passwordInput.value)
    {
